...
class codecfake(Dataset):
    def __init__(self, path_to_database, path_to_protocol, part='train'):
        ...
        self.label = {"fake": "fake", "real": "real"}  # Modificato per salvare come stringa
        ...
        print(f"Loaded {len(self.all_info)} files for {part}, skipped {skipped} missing files")
    ...
    def __getitem__(self, idx):
        ...
        return waveform, filename.replace('.wav', ''), self.label[label]
